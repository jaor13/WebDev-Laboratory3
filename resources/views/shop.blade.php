...
<div class="container mt-5">
    ...
    <div class="row mt-4">
        <div class="col-md-4 mb-custom"> 
            <div class="card">
                <img src="images/1.jpg" class="card-img-top" alt="Bouquet 1">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-custom">
            <div class="card">
                <img src="images/2.jpg" class="card-img-top" alt="Bouquet 2">
                <div class="card-body">
                    <h5 class="card-title">Bouquet 2</h5>
                    <p class="card-text">Sunflowers and tulip for a bright, cheerful arrangement.</p>
        ...
        <div class="col-md-4 mb-custom">
            <div class="card">
                <img src="images/3.jpg" class="card-img-top" alt="Bouquet 3">
                <div class="card-body">
                    <h5 class="card-title">Bouquet 3</h5>
                    <p class="card-text">A romantic blend of red and cream roses.</p><br>
        ...
        <div class="col-md-4 mb-custom">
            <div class="card">
                <img src="images/4.jpg" class="card-img-top" alt="Bouquet 4">
                <div class="card-body">
                    <h5 class="card-title">Bouquet 4</h5>
                    <p class="card-text">An elegant combination of roses and daisy.</p><br>
        ...
        <div class="col-md-4 mb-custom">
            <div class="card">
                <img src="images/5.jpg" class="card-img-top" alt="Bouquet 5">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-custom">
            <div class="card">
                <img src="images/6.jpg" class="card-img-top" alt="Bouquet 6">
                <div class="card-body">
                    <h5 class="card-title">Bouquet 6</h5>
                    <p class="card-text">A beautiful single sunflower.</p><br>
